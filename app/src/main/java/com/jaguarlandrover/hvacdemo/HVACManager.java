...
public class HVACManager
{
    ...
    private static ArrayList<String> SIGNED_PRIVILEGES =
    ...
    private static void generateKeysAndCerts() {
        ...
        }, 2048, false, start.getTime(), end.getTime(), X509_PRINCIPAL_PATTERN, RVILocalNode.getLocalNodeIdentifier(HVACApplication.getContext()), X509_ORG_UNIT);
    }
    ...
    private static void setUpRviAndConnectToServer(KeyStore serverCertificateKeyStore, KeyStore deviceCertificateKeyStore, String deviceCertificatePassword, ArrayList<String> newPrivileges) {
        ...
        try {
            ...
            if (newPrivileges != null)
                for (String privileges : newPrivileges)
                    SIGNED_PRIVILEGES.add(privileges);

            RVILocalNode.setPrivileges(HVACApplication.getContext(), SIGNED_PRIVILEGES);
